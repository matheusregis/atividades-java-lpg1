...
public class Exe1Main {
	public static void main(String[] args) {
		...
		Exe1AssistenteTecnico at = new Exe1AssistenteTecnico(nome, salario, cargo);
		
		nome = String.valueOf(JOptionPane.showInputDialog("Digite o nome:"));
		salario = Double.parseDouble(JOptionPane.showInputDialog("Digite o salário de "+nome));
		cargo = String.valueOf(JOptionPane.showInputDialog("Digite o cargo de "+nome));
		Exe1AssistenteAdministrativo aa = new Exe1AssistenteAdministrativo(nome, salario, cargo);
		
		nome = String.valueOf(JOptionPane.showInputDialog("Digite o nome:"));
		salario = Double.parseDouble(JOptionPane.showInputDialog("Digite o salário de "+nome));
		cargo = String.valueOf(JOptionPane.showInputDialog("Digite o cargo de "+nome));
		Exe1Gerente g = new Exe1Gerente(nome, salario, cargo);
